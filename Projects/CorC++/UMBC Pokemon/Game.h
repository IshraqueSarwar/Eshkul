...
public:
  ...
  // Postconditions - After random Pokemon of that rarity is chosen,            
  //                  this function reduces the CP of between 30-50%            
  Pokemon FoundPokemon(int rarity);//<--Done
  ...
  void AddPokemon(Pokemon newPokemon);//<--Done
  ...
  int FindPokemon(string name);//<--Done
